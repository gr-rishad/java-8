...
public class ParallelStreamExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Available processor in your machine::"+Runtime.getRuntime().availableProcessors());

        System.out.println("Sequential Stream Result:: "+ checkPerformanceResult(ParallelStreamExample::sumParallelStream,20));
